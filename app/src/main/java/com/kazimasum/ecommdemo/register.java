...
//                regpassord.setText("");
                ...
                if (t instanceof IOException) {
                    Toast.makeText(register.this, "this is an actual network failure :( inform the user and possibly retry", Toast.LENGTH_SHORT).show();
                    // logging probably not necessary
                }
                else {
                    Toast.makeText(register.this, "conversion issue! big problems :(", Toast.LENGTH_SHORT).show();
